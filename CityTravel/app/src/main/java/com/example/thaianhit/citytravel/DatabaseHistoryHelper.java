...
public class DatabaseHistoryHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String query = "CREATE TABLE "+ TABLE_HISTORY + " (" + HISTORY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + HISTORY_TENDIADIEM + " TEXT, " + HISTORY_TENDICHVU +" TEXT, " + HISTORY_DIACHI +" TEXT);";
