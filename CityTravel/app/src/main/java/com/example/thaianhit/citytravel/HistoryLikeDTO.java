...
public class HistoryLikeDTO implements Parcelable {
    ...
    public static final Parcelable.Creator<HistoryLikeDTO> CREATOR = new Parcelable.Creator<HistoryLikeDTO>() {
        @Override
        public HistoryLikeDTO createFromParcel(Parcel source) {
            return new HistoryLikeDTO(source);
        }

        @Override
        public HistoryLikeDTO[] newArray(int size) {
            return new HistoryLikeDTO[size];
        }
    };
